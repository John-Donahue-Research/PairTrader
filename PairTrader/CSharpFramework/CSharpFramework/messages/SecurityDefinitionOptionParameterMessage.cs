...
namespace CSharpFramework.ui
{
    class SecurityDefinitionOptionParameterMessage : IBMessage
    {
        ...
        public SecurityDefinitionOptionParameterMessage(int reqId, int underlyingConId, string tradingClass, string multiplier, HashSet<string> expirations, HashSet<double> strikes)
        {
